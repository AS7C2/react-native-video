...
- (void)playerItemForSource:(NSDictionary *)source withCallback:(void(^)(AVPlayerItem *))handler
{
  ...
  if ([uri hasPrefix:@"ph://"]) {
    ...
    NSString *loadedIdentifier = [photosFrameworkExtension
                                  startLoadingPhotosAsset:source
                                  bufferingCallback:self.onVideoBuffer
                                  andReactTag:self.reactTag
                                  andCompleteBlock:^(NSDictionary *source,
                                                     AVAsset *asset,
